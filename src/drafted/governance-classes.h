 ...
 *
 *   // network
 *   CStannumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.stannum.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CStannumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CStannumNetwork(UniValue objIn)
    {
...
// // can be under: StannumNetwork
// //   -- signature requirements : Key1(User)
// class CStannumNetworkVariable : public CGovernanceObject
// {
// private:
