...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "StannumNetwork") type = StannumNetwork;
    if(strType == "StannumNetworkVariable") type = StannumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == StannumNetwork) s = "StannumNetwork";
    if(type == StannumNetworkVariable) s = "StannumNetworkVariable";
