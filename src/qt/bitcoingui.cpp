    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Stannum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stannum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stannum: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Stannum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Stannum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Stannum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stannum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stannum addresses"));
    ...
    openAction->setStatusTip(tr("Open a stannum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stannum Core help message to get a list with possible Stannum Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Stannum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stannum network", "", count));
}
...
{
    QString strTitle = tr("Stannum Core"); // default title
