    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Stannum Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Stannum Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stannum-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Stannum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SNC, 0.1 SNC, 1 SNC and 10 SNC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://stannumcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://stannumcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Stannum Core is shutting down...") + "<br /><br />" +
