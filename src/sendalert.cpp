...
2. run stannumd with -printalert or -sendalert like this:
   /path/to/stannumd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.stannum.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Stannum Core:0.12.0.58/"));
