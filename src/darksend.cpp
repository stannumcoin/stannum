...
{
    if(fLiteMode) return; // ignore all Stannum related functionality
...
/*
    ...
    allow endless transaction that would bloat Stannum and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("stannum-privatesend");
