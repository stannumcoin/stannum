...
Stannum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Stannum Core, where everyone uses
...
pay attention to for reviewers of Stannum Core code.

General Stannum Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Stannum Core uses tinyformat, which is type safe. Leave them out to avoid confusion
