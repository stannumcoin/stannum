...
Only requiring some minor changes is stannum.cpp.
...
Changes to stannum.cpp
----------------------
stannum.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
