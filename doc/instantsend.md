...
This mechanism has been integrated into Bitcore-Node-Stannum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stannumcoin/insight-api-stannum#web-socket-api](https://github.com/stannumcoin/insight-api-stannum#web-socket-api) 
* API: [https://github.com/stannumcoin/insight-api-stannum#instantsend-transactions](https://github.com/stannumcoin/insight-api-stannum#instantsend-transactions) 
...
By default, the Stannum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stannum Core daemon:
