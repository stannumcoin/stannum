...
Stannum (GBX) is an innovative cryptocurrency. A form of digital currency secured by cryptography and issued through a decentralized and advanced mining market. Based on Dash, it's an enhanced and further developed version, featuring the masternode technology with 50% Reward, near-instant and secure payments as well as anonymous transactions. Stannum has great potential for rapid growth and expansion. Based on a total Proof of Work and Masternode system, it is accesible to everyone, it ensures a fair and stable return of investment for the Graphics Processing Units (GPUs) miners and the Masternode holders.
...
Stannum Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
[Tags](https://github.com/stannumcoin/stannum/tags) are created to indicate new official,
stable release versions of Stannum Core.
